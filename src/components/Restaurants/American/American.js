...
class American extends Component {
    render(){
        ...
        return (
            <React.Fragment>
                 <Helmet>
                    <title>The Dining Room | American Couisine</title>
                    <meta name="keywords" 
                            content="food, meal, snack, USA"
                    />
                    <meta
                        name="description"
                        content="Selection of best American restaurants"
                    />
                </Helmet>
...
export default connect(mapStateToProps, null)(American);