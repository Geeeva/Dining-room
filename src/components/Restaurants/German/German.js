...
class German extends Component {
    render(){
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>The Dining Room | German Couisine</title>
                    <meta name="keywords" 
                            content="food, meal, snack, Germany"
                    />
                    <meta
                        name="description"
                        content="Selection of best German restaurants"
                    />
                </Helmet>
...
export default connect(mapStateToProps, null)(German);