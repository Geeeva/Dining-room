...
class Vegeterian extends Component {
    render(){
        const initialPage = 1;
        const maxPerPage = 12;
        let maxPages = 1;
        ...
        return (
            <React.Fragment>
                <Helmet>
                    <title>The Dining Room | Vegeterian Specialties</title>
                    <meta name="keywords" 
                        content="food, meal, snack, vegan "
                    />
                    <meta
                        name="description"
                        content="Selection of best Vegan restaurants"
                    />
                </Helmet>
...
export default connect(mapStateToProps, null)(Vegeterian);